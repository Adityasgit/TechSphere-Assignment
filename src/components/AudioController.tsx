...
import { FaPlay, FaPause, FaForward, FaBackward, FaVolumeUp, FaVolumeMute, FaEllipsisH } from 'react-icons/fa';

const AudioControls = ({ currentSong, isPlaying, onPlayPause, onNext, onPrevious, onVolumeChange, audioRef }) => {
